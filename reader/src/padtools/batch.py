"""폴더 일괄 판독 CLI.
    ...
    python -m padtools.batch images/ --tone white --set dust.depth_threshold=0.08
...
def _row(path: Path, result) -> dict[str, Any]:
    ...
    return {
        ...
        "point_id_status": payload["point_id_status"],
        "point_id_confidence": payload["point_id_confidence"],
