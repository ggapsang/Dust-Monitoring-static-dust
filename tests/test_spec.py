...
def test_target_id_box_contains_digits(mask: np.ndarray) -> None:
    """TARGET_ID 박스가 숫자를 전부 감싸는지. TARGET_ID 판독 ROI 다."""
    box = spec.LEGACY.target_id_box
    ...
    assert not leaked.any(), "TARGET_ID 박스 밖 상단 밴드에 인쇄물이 남았다"
